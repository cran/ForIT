#' ForIT: A package that implements as R functions the INFC-2005 equations estimating single tree volume and phytomass .
#'
#' The ForIT package provides two main functions, estimating respectively individual and summary
...
#' della fitomassa arborea epigea}. 412 pp.
#'
